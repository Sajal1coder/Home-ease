...
const ListingDetails = () => {
  ...
  const getListingDetails = async () => {
    try {
      const response = await fetch(
        `https://home-easy-green.vercel.app/properties/${listingId}`,
        {
          method: "GET",
        }
      );
  ...
  const handleSubmit = async (token) => {
    ...
    try {
      ...
      const response = await fetch("https://home-easy-green.vercel.app/bookings/create", {
        method: "POST",
        headers: {
      ...
      <div className="listing-details">
        ...
        <div className="photos">
          {listing.listingPhotoPaths?.map((item) => (
            <img
              src={`https://home-easy-green.vercel.app/${item.replace("public", "")}`}
              alt="listing photo"
            />
          ))}
        </div>
        ...
        <div className="profile">
          <img
            src={`https://home-easy-green.vercel.app/${listing.creator.profileImagePath.replace(
              "public",
              ""
            )}`}
          />
